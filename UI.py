...
[red]1 - Warrior : Strong and stupid[/red]
[blue]2 - Mage : Weirdo with magic[/blue]
[yellow]3 - Thief : Sneaky little rat[/yellow]
""",border_style="cyan", title="Choisis ta classe")))
        ...
        if char == '1' :
            ...
            console.print(Align.center(f"[blue bold]tu as choisis ton nom ! Ca sera {name}[/blue bold]"))
